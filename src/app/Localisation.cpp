...
juce::String Localisation::getIndonesianTranslations()
{
    ...
    return juce::String("language: Indonesian\n")
        ...
        + "\"Playing until an instrument is loaded\" = \"Berbunyi sampai ada instrument dimuat\"\n"
        + "\"Drum kit channel - each pad carries its own shape\" = "
          "\"Channel drum kit - tiap pad punya bentuknya sendiri\"\n"
