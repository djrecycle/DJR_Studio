...
juce::String Localisation::getIndonesianTranslations()
{
    ...
    return juce::String("language: Indonesian\n")
        ...
        + "\"Fade in\" = \"Fade in\"\n"
        + "\"Fade out\" = \"Fade out\"\n"
        + "\"the last edit\" = \"edit terakhir\"\n"
        + "\"Missing audio clip: \" = \"Clip audio hilang: \"\n"
        + "\" is missing: \" = \" hilang: \"\n"
        + "\"Sample editor: \" = \"Editor sampel: \"\n"
        + "\"That clip has no audio to edit.\" = \"Clip itu tidak punya audio untuk diedit.\"\n"
        + "\"Nothing to change: the clip is already like that.\""
          " = \"Tidak ada yang berubah: clip-nya memang sudah begitu.\"\n"
        + "\"Double click an audio clip in the playlist to edit its samples.\""
          " = \"Klik dua kali clip audio di playlist untuk mengedit sampelnya.\"\n"
        + "\"Normalize sample\" = \"Normalisasi sampel\"\n"
        + "\"Reverse sample\" = \"Balik sampel\"\n"
        + "\"Export...\" = \"Ekspor...\"\n"
        + "\"Export sample\" = \"Ekspor sampel\"\n"
        + "\"Sample exported: \" = \"Sampel diekspor: \"\n"
        + "\"Export failed: \" = \"Ekspor gagal: \"\n"
        + "\"There is no sample to export.\" = \"Tidak ada sampel untuk diekspor.\"\n"
        + "\"No audio formats are available to write with.\""
          " = \"Tidak ada format audio yang bisa dipakai menulis.\"\n"
        + "\"Cannot write to that folder.\" = \"Tidak bisa menulis ke folder itu.\"\n"
        + "\"Cannot write to that file.\" = \"Tidak bisa menulis ke berkas itu.\"\n"
        + "\"That format cannot be written.\" = \"Format itu tidak bisa ditulis.\"\n"
        + "\"Writing the sample failed.\" = \"Penulisan sampel gagal.\"\n"
        + "\"Sample Editor\" = \"Editor Sampel\"\n"
        + "\" smp / px\" = \" smp / px\"\n"
        + "\" px / smp\" = \" px / smp\"\n"
        + "\" smp\" = \" smp\"\n"
        ...
        + "\"Random\" = \"Acak\"\n"
        + "\" oct\" = \" oktaf\"\n"
        + "\"The channel's own envelope, LFO and filter. A pitch envelope is drawn but not yet played.\""
          " = \"Envelope, LFO dan filter milik channel. Envelope pitch tergambar tapi belum dimainkan.\"\n"
        + "\"The arpeggiator and the echo are live; the rest of this page is drawn while its engine is built.\""
          " = \"Arpeggiator dan echo sudah jalan; sisa halaman ini tergambar sambil mesinnya dibuat.\"\n"
        + "\"Generator\" = \"Generator\"\n"
        ...
        + "\"Bounce to audio\" = \"Bounce ke audio\"\n"
        + "\"Channel settings...\" = \"Pengaturan channel...\"\n"
        + "\"Channel\" = \"Channel\"\n"
        + "\"Preview instrument\" = \"Instrument preview\"\n"
        + "\"This channel has no plugin, so it plays through the built-in preview "
          ...
          "\"Channel ini belum punya plugin, jadi bunyinya lewat instrument preview "
          "bawaan. Halaman Envelope dan Misc tetap bekerja padanya, sama seperti pada "
          "plugin; muat sebuah instrument ke track untuk menggantikannya.\"\n"
