...
juce::String Localisation::getIndonesianTranslations()
{
    ...
    return juce::String("language: Indonesian\n")
        ...
        + "\"The arpeggiator is live; the rest of this page is drawn while its engine is built.\""
          " = \"Arpeggiator sudah jalan; sisa halaman ini tergambar sambil mesinnya dibuat.\"\n"
        + "\"Generator\" = \"Generator\"\n"
